...
{
    public partial class PesquisarRua : Form
    {
        public PesquisarRua()
        {
            InitializeComponent();
        ...
        {
            Agenda.RuaAgenda = txb_PesquisarRua.Text;

            ManipulaAgenda.VisualizarRua();
            ...
            dataGridView1.DataSource = ManipulaAgenda.VisualizarRua();
